...
class util_of_lpips():
    ...
    def calc_lpips(self, img1_path, img2_path):
        ...
        img0 = torch.from_numpy(sitk.GetArrayFromImage(sitk.ReadImage(img1_path)))
        img1 = torch.from_numpy(sitk.GetArrayFromImage(sitk.ReadImage(img2_path)))
...
lpips_model = util_of_lpips('vgg', True)
print(lpips_model.calc_lpips('000_000.nii','Xgt.nii'))