...
def configure(dir=None, format_strs=None, comm=None, log_suffix="", method_name=None):
    """
    ...
    if dir is None:
        dir = osp.join(
            # tempfile.gettempdir(),
            dir,
            f"{method_name}-{time_str}",
        )
    assert isinstance(dir, str)
    dir = os.path.join(os.path.expanduser(dir), f"{method_name}-{time_str}")
