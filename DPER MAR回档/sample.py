...
def main():
    ...
    log_dir = logger.configure(dir="./experiments/sample")
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        utils.save_nii_image((sample+1), os.path.join(log_dir, "sample.nii"))
    ...
    if dist.get_rank() == 0:
        ...
        save_images(arr, out_path)
        out_path = os.path.join(args.save_dir, f"samples_{shape_str}_{samples_index}.nii")
        sitk.WriteImage(sitk.GetImageFromArray(arr.squeeze()), out_path)
