...
def imaging_geo(param):
    ...
    geometry_h = odl.tomo.FanBeamGeometry(
        angle_partition, detector_partition_h, src_radius=param.param["dso"], det_radius=param.param["dde"]
    )
    ...
    ray_trafo_hh = odl.tomo.RayTransform(
        reco_space_h, geometry_h, impl="astra_cuda"
